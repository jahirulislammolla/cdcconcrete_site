...
@section('contents')
                                    ...
                                    @foreach ($all as $key => $item)
                                        ...
                                        <tr class="text-center">
                                            ...
                                            <td>
                                                ...
                                                <a onclick="return confirm('Are you sure?')" href="{{ route('editor_equipment_information_delete',['id'=>$item->id]) }}" class="btn btn-danger btn-sm m-1"><i class="fa fa-trash"></i> Delete</a>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
        ...
        <div class="modal-dialog modal-lg modal-center" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalCreateLabel">Add Plant & Equipment Information</h5>
                ...
                <div class="modal-body">
                    <!-- Modal body -->
                    <form id="contact_create_form" action="{{ route('editor_equipment_information_create') }}" enctype="multipart/form-data" method="POST">
                        @csrf
                        <div class="modal-body">
                            <div class="form-group mb-3">
                                <label for="name">Plant & Equipment Name:</label>
                                <input type="text"  id="name" name="name" placeholder="name" class="form-control input_val"  required/>
                            </div>
 
                            <div class="form-group mb-3">
                                <label for="image">Plant & Equipment Image(600x400):</label>
                                <input type="file"  id="image" name="image" class="form-control input_val" required/>
                            </div>
                            <div class="form-group mb-3">
                                <label for="description">Plant & Equipment Description:(Short description)</label>
                                <input type="text"  id="description" name="description" placeholder="description.." class="form-control input_val" />
                            </div>
                        </div>
    ...
    <div class="modal fade" id="exampleModalUpdate" tabindex="-1" aria-labelledby="exampleModalUpdateLabel" style="display: none;" aria-hidden="true">
        <div class="modal-dialog modal-lg modal-center" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalUpdateLabel">Update Plant & Equipment Information</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true"></span>
                    </button>
                </div>
                <div class="modal-body">
                    <!-- Modal body -->
                    <form id="contact_update_form" action="{{ route('editor_equipment_information_update') }}" enctype="multipart/form-data" method="POST">
                        @csrf
                        <div class="modal-body">
                            <div class="form-group mb-3">
                                <label for="name">Plant & Equipment Name:</label>
                            ...
                            <div class="form-group mb-3">
                                <label for="description">Plant & Equipment Description:(Short description)</label>
                                <input type="text"  id="update_description" name="description" class="form-control input_val"/>
                            </div>
